...
class VideoContentCrew:
    ...
    def run(self, job_id: str = "unknown") -> VideoContentPackage:
        ...
        try:
            ...
            # --- Generate videos via ComfyUI (if api_wrapper_url + token provided) ---
    ...
    def _generate_videos(self, package: VideoContentPackage, job_id: str) -> VideoContentPackage:
        ...
        comfyui_url = self.request.comfyui_url  # for downloads

        logger.info(f"Starting ComfyUI video generation via wrapper: {api_wrapper_url}")
